...
Once TASK-036 gives hourly, verified, encrypted, offsite snapshots with two-year retention, that store is a second answer to the same question, with shallower history and no verification. Removing it returns bin/backup to what it should always have been: plain rclone syncs behind two guards, about 35 lines shorter.
