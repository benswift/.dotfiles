...
#
# Not listed here: ~/.codex/skills, which is populated per-skill at ben
# plugin bootstrap time (bin/sync-agent-config) because the marketplace
# clone doesn't exist until claude has run.
