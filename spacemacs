...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(lice csv z3-mode imenu-anywhere dracula-theme monokai-theme subatomic-theme)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '(("Operator Mono" :size 18 :weight normal :width normal)
							   ("Source Code Pro" :size 36 :weight normal :width normal)
...
before packages are loaded."
  ...
  (load-file (expand-file-name "~/Documents/teaching/comp2710-lens-2020/convenors/scripts/comp2710-lens.el"))
  )
